...
#cfg release  "cfg_release"
#Add to build the cfg files selected from 0 to "cfg_release" value (from 1000 to 1000+"cfg_release")
#If "cfg_release"  is set to 0 none of them are selected

%define with_optimization  1
%if 0%{with_optimization}

Source1001: 01-Config-Disabled-IPC-Timers-Audit.cfg
Source1002: 02-Config-Disabled-Kconfig-Scheduler-Initrd.cfg
Source1003: 03-Config-Disabled-Perf-Profiling-Errata.cfg
Source1004: 04-Config-Disabled-EFI-Power-Debug.cfg
Source1005: 05-Config-CPUFreq-Schedutil-No-Virt.cfg
Source1006: 06-Config-Disabled-Kprobes-Jumplabel.cfg
Source1007: 07-Config-No-GCC-Plugins-Block-Align.cfg
Source1008: 08-Config-Disabled-Partitions.cfg
Source1009: 09-Config-Arch-Inline-Spinlocks.cfg
Source1010: 10-Config-No-Swap-Hotplug-KSM.cfg
Source1011: 11-Config-Disabled-Network-IPV4-IPV6-Netfilter.cfg
Source1012: 12-Config-SCTP-No-VLAN-TIPC-BATMAN.cfg
Source1013: 13-Config-Disabled-Wireless-BT-CAN-RFKILL.cfg
Source1014: 14-Config-Disabled-PCI-Firmware.cfg
Source1015: 15-Config-No-GNSS-ProcEvents.cfg
Source1016: 16-Config-Disabled-Block-NBD-AoE.cfg
Source1017: 17-Config-Eeprom-93CX6-Others-Disabled.cfg
Source1018: 18-Config-No-Network-Devices-Bond-Vendor.cfg
Source1019: 19-Config-Disabled-PHY-Drivers.cfg
Source1020: 20-Config-No-PPP-WLAN-Yes-Failover.cfg
Source1021: 21-Config-No-Input-Devices.cfg
Source1022: 22-Config-No-Serial-TTY-TPM.cfg
Source1023: 23-Config-Disabled-I2C-Power-Sensors.cfg
Source1024: 24-Config-No-MFD-Display-Media.cfg
Source1025: 25-Config-No-USB-Sound-RTC-VirtIO.cfg
Source1026: 26-Config-No-FS-Encodings.cfg
Source1027: 27-Config-Crypto-Core-SHA3-XTS.cfg
Source1028: 28-Config-Crypto-DRBG-Jitter-No-HW.cfg
Source1029: 29-Config-No-Kernel-Debug.cfg
Source1030: 30-Config-No-FS-Verity-SecurityFS.cfg

#23-miscellaneous.cfg:15:# CONFIG_PRINTK_TIME is not set ???
#Mandatory To Set # CONFIG_DEBUG_FS is not set
#Mandatory To Set # CONFIG_NETDEVICES is not set
#Mandatory To Set # CONFIG_DMADEVICES is not set #Not OK: No network
#Mandatory To Set # CONFIG_PINCTRL is not set #No boot
#Mandatory To Set # CONFIG_VFAT_FS is not set #No boot
#Need to be set to activate serial.
# CONFIG_SERIAL_8250 is not set
#Mandatory To Set # CONFIG_I2C_OMAP is not set # no boot
#Mandatory To Set # CONFIG_DEVTMPFS is not set # no boot
#Mandatory To Set # CONFIG_WATCHDOG is not set # no boot
#Mandatory To Set # CONFIG_PINCTRL is not set # no boot
#Mandatory To Set # CONFIG_REGULATOR is not set # 10 sec daylaid added
#Mandatory To Set # CONFIG_BPF_SYSCALL is not set # not building
#Mandatory To Set # CONFIG_BPF_JIT is not set # not building
#Mandatory To Set # CONFIG_SUSPEND is not set # 10 sec daylaid added

#cfg tested 
#Add to build only the one cfg file selected by "cfg_tested" value (1100+"cfg_tested")
#if "cfg_tested" is set to 0 none of them is selected

#Source11XX: XXX-XXX-XXX.cfg

Source1101: 27.1-fragment.cfg 
Source1102: 27.2-fragment.cfg 
Source1103: 27.3-fragment.cfg 
Source1104: 27.4-fragment.cfg 
Source1105: 27.5-fragment.cfg
